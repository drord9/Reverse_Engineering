...
_main:
	...
	mov	eax, ecx
	add	eax, 1
	mov	DWORD PTR [ebp-4], eax#random number
...
L6:
	...
	lea	eax, [ebp-8]
	call	_scanf
	mov	eax, DWORD PTR [ebp-8]#input
	cmp	eax, DWORD PTR [ebp-4]#compare random number to the input
	jle	L2#if random number is smaller or equal go to L2
